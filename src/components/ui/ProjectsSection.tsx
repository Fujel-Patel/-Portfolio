...
const projects = [
  {
    ...
    fullDescription: 'A cutting-edge e-commerce platform that revolutionizes online shopping through immersive 3D product visualization. Users can interact with products in real-time, view them from all angles, and even use AR to see how items would look in their space before purchasing.',
    tags: ['React', 'Three.js', 'Node.js'],
    technologies: ['React', 'Three.js', 'React Three Fiber', 'Node.js', 'Express', 'MongoDB', 'WebGL', 'AR.js'],
    features: [
  ...
  },
  {
    ...
    fullDescription: 'An intelligent analytics dashboard that leverages machine learning to provide predictive insights and real-time data visualization. The platform helps businesses make data-driven decisions by transforming complex datasets into actionable insights.',
    tags: ['Next.js', 'TypeScript', 'Python'],
    technologies: ['Next.js', 'TypeScript', 'Python', 'TensorFlow', 'D3.js', 'PostgreSQL', 'FastAPI', 'Docker'],
    features: [
  ...
  },
  {
    ...
    fullDescription: 'A modern social media platform designed for creative professionals. Features real-time messaging, content sharing, collaborative workspaces, and AI-powered content recommendations. Built with performance and scalability in mind.',
    tags: ['React Native', 'Firebase', 'GraphQL'],
    technologies: ['React Native', 'Firebase', 'GraphQL', 'Apollo', 'Node.js', 'Redis', 'WebSocket', 'TensorFlow'],
    features: [
